      ...
      <ScrollView style={{ top: 30 }}>
        ...
        <View style={styles.table}>
          <View style={styles.headerRow}>
            <Text style={[styles.cell2, styles.headerCell]}>ID</Text>
            ...
            <Text style={[styles.cell, styles.headerCell]}>Tb Num</Text>
          ...
          {orders.map((order) => (
            <View style={styles.row} key={order.id}>
              ...
              <Text style={styles.cell}>{order.tableNumber}</Text>
              ...
              <Text style={styles.cell}>{order.orderedAt.toDate().toDateString()}</Text>
